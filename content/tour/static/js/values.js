...
angular
  ...
  .value("tableOfContents", [
    {
      ...
      title: "Usando o tour",
      description:
        '<p>Bem-vindo ao tour pela <a href="http://golang.org">linguagem de programação Go</a>. O tour cobre as características mais importantes da linguagem, principalmente:</p>',
      lessons: ["welcome"],
    },
    {
      id: "basics",
      title: "Básico",
      description:
        "<p>O ponto inicial é aprender todo básico da linguagem.</p><p>Declarando variáveis, chamando funções, e todas as coisas que você precisa saber para avançar para próxima lição.</p>",
    ...
    },
    {
      ...
      description:
        "<p>Aprenda como definir métodos nos tipos, como declarar interfaces e como juntar todas as coisas.</p>",
      lessons: ["methods"],
    },
    {
      id: "generics",
      title: "Genéricos",
      description:
        "<p>Aprenda como usar parâmetros de tipo em funções e estruturas Go.</p>",
      lessons: ["generics"],
    },
    {
      id: "concurrency",
      title: "Concorrência",
      description:
        "<p>Go oferece recursos de concorrência como parte do núcleo da linguagem.</p><p>Este módulo será sobre goroutines e canais, e como eles são usados para implementar diferentes padrões de concorrência.</p>",
      lessons: ["concurrency"],
    },
  ])
  // translation
  .value("translation", {
    ...
    "submit-feedback": "Envie-nos um feedback sobre esta página",

    // GitHub issue template: update repo and messaging when translating.
    "github-repo": "github.com/dgv/go-tour-br",
    "issue-title": "tour: [SUBSTITUA COM UMA BREVE DESCRIÇÃO]",
    "issue-message":
