...
value('tableOfContents', [{
    'id': 'mechanics',
    'title': 'Usando o tour',
    'description': '<p>Bem-vindo ao tour pela <a href="http://golang.org">linguagem de programação Go</a>. O tour cobre as características mais importantes da linguagem, principalmente:</p>',
    'lessons': ['welcome']
}, {
    'id': 'basics',
    'title': 'Básico',
...
value('translation', {
    ...
    'github-repo': 'github.com/golangbr/go-tour-br',
    'issue-title': 'tour: [SUBSTITUA COM UMA BREVE DESCRIÇÃO]',
    'issue-message': 'Mude o título acima para descrever seu problema e adicionar seu feedback aqui, incluíndo código se necessário',
    'context': 'Contexto',
}).
